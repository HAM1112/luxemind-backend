...
urlpatterns = [
    ...
    path(
        "getCourseDetails/<int:course_id>/", getCourseDetails, name="getCourseDetails"
    ),
    path("updateCourse/<int:course_id>", updateCourse, name="updateCourse"),
    path("addModule/", addModule, name="addModule"),
    path(
        "getCurriculumDetails/<int:course_id>/",
        getCurriculumDetails,
        name="getCurriculumDetails",
    ),
    ...
    path(
        "get_lesson_details/<int:lesson_id>", get_lesson_details, name="lesson-details"
    ),
    path("quiz/", QiuzViewSet.as_view(), name="quoz"),
]
